...
import { Plus, Pencil, Trash2, ExternalLink, AlertCircle, Film, Download } from 'lucide-react'
...
export function VideosCurtosTab({ onNavigate }) {
  const { items, addItem, updateItem, deleteItem, toggleStage } = useCollection('videosCurtos')
